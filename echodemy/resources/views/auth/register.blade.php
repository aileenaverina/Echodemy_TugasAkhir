<x-guest-layout>
    <div class="min-h-screen bg-cream px-4 py-10">
        <div class="max-w-2xl mx-auto">
            ...
            <p class="text-sm text-ink/60 mb-6">Lengkapi profil sekolah di bawah. Admin akan meninjau dan mengonfirmasi
                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-5">
                    ...
                    <div>
                        <x-input-label for="logo" value="Logo Sekolah"
                            class="text-xs font-semibold tracking-wide uppercase text-ink/70" />
                        <label for="logo"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="kabupaten_kota" disabled
                                class="mt-2 block w-full rounded-lg border-ink/15 bg-cream/40 focus:border-coral focus:ring-coral text-sm disabled:opacity-50"
                                required>
                    ...
                    <p class="text-xs text-ink/50 -mt-1">Akun login sekolah akan dikirim ke email ini setelah
