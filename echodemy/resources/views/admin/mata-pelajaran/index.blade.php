<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-xs font-semibold tracking-widest text-coral uppercase mb-1">Manajemen Mata Pelajaran</p>
    ...
    <form method="GET" action="{{ route('admin.mata-pelajaran.index') }}" id="search-form" class="mb-5">
        <div class="relative max-w-md">
            ...
            <input type="text" name="search" id="search-input" value="{{ $search }}" placeholder="Cari Nama Mata Pelajaran..."
            ...
            <tbody>
                @forelse ($mataPelajarans as $mapel)
                    <tr class="border-b border-border last:border-0">
                        ...
                        <td class="px-5 py-4">
                            <span class="inline-block w-4 h-4 rounded-full" style="background-color: {{ $mapel->warna }}"></span>
                        </td>
                        <td class="px-5 py-4">
    ...
    <div id="view-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center px-4">
        <div class="modal-overlay absolute inset-0 bg-ink/40"></div>
        <div class="relative bg-putih rounded-2xl shadow-lg w-full max-w-md p-6">
            <p class="text-xs font-semibold tracking-widest text-coral uppercase mb-1">Detail Mata Pelajaran</p>
            ...
            <div class="space-y-3 text-sm">
                ...
                <div class="flex justify-between"><span class="text-hitam2">Dipakai di</span><span id="view-dipakai" class="font-medium">-</span></div>
                <div class="flex justify-between items-center">
                    <span class="text-hitam2">File</span>
                    <a id="view-file" href="#" target="_blank" class="text-coral font-medium hover:underline">Lihat file</a>
                </div>
            </div>
    ...
    <div id="edit-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center px-4">
        <div class="modal-overlay absolute inset-0 bg-ink/40"></div>
        <div class="relative bg-putih rounded-2xl shadow-lg w-full max-w-md p-6">
            <p class="text-xs font-semibold tracking-widest text-coral uppercase mb-1">Edit Mata Pelajaran</p>
